...
if __name__ == "__main__":
    ...
    parser.add_argument('--interaction_data',
                        default="/2014110079/PPIGAN/PPIGAN/Dataset/Biogrid-human/third_human_MV_pair.tsv",
                        type=str)
    parser.add_argument('--sequence_data',
                        default="/2014110079/PPIGAN/PPIGAN/Dataset/Biogrid-human/double_human_MV_database.tsv",
                        type=str)
    ...
    parser.add_argument('--d_pth', default="/2014110079/PPIGAN/PPIGAN/models/dis_after_gen/yeast/D_best_4_0.9674_gen(x,z)_deeptrio_degree_0907.pth", required=False, type=str,
